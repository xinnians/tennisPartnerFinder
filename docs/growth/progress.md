...
| G09 | 擴充已核可；共十篇查核完成 | 擴充完成 | 擴充驗證中 | 三篇已部署，七篇待發布 | 未取得 |
...
## 2026-09-09 G09／全台球場擴充（已核可，驗證中）

- 使用者「ok，請開始」已核可台北指南擴至 10–15 篇與全台待審底稿；沒有跨縣市開局核可。
- 盤點既有目錄 89 座（台北 61、新北 28），正式指南 3 篇。建議先將台北完整指南擴至 10–15 篇，同時建立全台待審資料底稿與品質報告；目錄、指南與約球開放範圍分開處理。
- 已新增七篇指南，共 10 篇；全台來源 15,001 列篩出 562 筆待審候選，產生品質報告及離線驗證。正式球場 seed／DB 維持不變；底稿不進網站 bundle。
- 分支 `codex/g09-expansion-national-catalog`；[執行紀錄](g09-expansion-implementation-2026-09-09.md)、[品質報告](national-courts-quality-2026-09-09.md) 保存查核差異與接續方法。目前本機回歸中，尚未發布本批；其他暫緩 G 項仍不啟動。
