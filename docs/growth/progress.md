...
- 現有16篇已發布，45筆未發布。C02本批先復興、洲美、榮華，再接續同批其餘5候選（南港、玉成、中研、迪化、新生），每批最多10筆；未確認者保留待來源。工作分支 `codex/court-guide-completion-c02`。本批8筆已查核，復興／榮華／洲美／迪化四篇內容完成（本機20、正式16），其餘4筆待來源／現況；[證據卡](court-guide-completion-c02-2026-09-09.md)已保存。本機frontend／local／mobile／preview Chromium及WebKit、正式容量及hosted唯讀preflight通過；Git預覽完成（初次開局測試單次pageerror，後兩輪通過，詳見C02）；必要CI進行中，尚未部署。
