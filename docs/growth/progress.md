...
## 2026-09-09 G09／全台球場擴充評估（尚未執行）

- 使用者詢問是否補齊所有指南及建立全台球場資料；目前僅評估，不視為跨縣市開局核可。
- 盤點既有目錄 89 座（台北 61、新北 28），正式指南 3 篇。建議先將台北完整指南擴至 10–15 篇，同時建立全台待審資料底稿與品質報告；目錄、指南與約球開放範圍分開處理。
- [可行性與分階段建議](g09-national-catalog-assessment-2026-09-09.md) 記錄官方來源、年度更新限制、seed 停用風險及驗收方向。未匯入、未改 runtime／DB、未建立排程或部署；只驗證文件 diff。其他暫緩 G 項仍不啟動。
