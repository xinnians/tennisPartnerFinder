...
最後更新：2026-09-09。G02／G03／G04／G10 已上線；G09 已擴至 20 篇並加入名稱／行政區查找，均已正式部署，全台 562 筆待審底稿與品質報告已建立。正式站驗證及真實成效分開記錄。
...
- C03下一組10筆已建立[來源底稿](court-guide-completion-c03-2026-09-09.md)，目前查核中而非已可發布；先接續葫蘆洲資格／費率單位，再查公園現場規則。
...
- 最新範圍：G09 二十篇球場指南與名稱／行政區查找、全台待審底稿，以及已上線的 G10 逐局分享預覽；C01首批與C02查核完成處置，北投及本批四座公園指南已於 qiuka.tw 上線，部分疑義保留。G01、G05–G08、G11–G12 暫緩。
...
| G09 | C01首批及C02十座有查核處置，C03查核中 | 二十篇完成；全台底稿待審 | 本批必要CI／Safari及正式頁面通過 | 二十篇已部署，底稿未公開 | 未取得 |
