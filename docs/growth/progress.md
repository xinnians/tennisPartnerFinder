...
1. 十五篇指南及查找已上線；下一輪可補查青年清晨時間、天母／北投營運資訊，或另規劃資訊更正入口（尚未實作）。台北既有61座中15篇已發布，剩餘46筆須逐場查核資格，不承諾全部適合公開。不要把562筆全台候選自動發布或用來停用既有球場。依使用者實際回饋修正 G09／G10；若要取得轉換／留存數據，先重新確認是否啟動已暫緩的 G01，不把工程測試當產品成效。
