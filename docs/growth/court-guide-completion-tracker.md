...
建立／更新：2026-09-10。對應 [補完計畫](court-guide-completion-plan.md)，總發布狀態見 [progress.md](progress.md)。台北61筆皆有首輪處置，61篇已正式發布；38篇保留指南動作，23篇開放狀態待確認且暫無指南開局／訂閱。8篇位置有疑義者無導航。最新[發布與QA](court-guide-pending-publication-2026-09-10.md)記錄本批規則與限制；前次[目標驗收](court-guide-completion-acceptance-2026-09-09.md)保留首輪28篇的歷史基準。
...
| --- | --- | --- | --- | --- | --- | --- |
| P1 | 天母運動公園網球場／`tianmu-sports-park` | 士林區 | 待補來源 | 已發布 | 已讀會員表單首次免費註冊／櫃檯驗證流程；待粉專直接表單連結及現行費時 | [2026-09-10第二輪補證](court-guide-evidence-followup-2026-09-10.md) |
| P1 | 南港公園網球場／`nangang-park` | 南港區 | 待補來源 | 已發布 | 2026-09-10舊VBS609明列現場輪流／禁營利；待新版適用、輪替細節／費用及iPlay23084全文 | [2026-09-10進度補證](progress.md) |
...
| P0 | 新生公園網球場／`xinsheng-park` | 中山區 | 待釐清現況 | 已發布（開放待確認） | 2026-07-27開幕新聞明列網球；待原位置對應、網球專屬開放／使用流程 | [2026-09-10第二輪補證](court-guide-evidence-followup-2026-09-10.md) |
