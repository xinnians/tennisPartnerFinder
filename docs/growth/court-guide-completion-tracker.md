...
- 台北61筆：24篇已發布，37筆未發布（5筆C02待來源／現況，另32筆後續）；新北28筆未發布。合計89筆既有目錄，不代表全台總數。
...
C01首批重新查核民權、青年、道南、百齡及北投，C02新增復興、榮華、洲美、迪化，其餘承接第二批紀錄。22篇有明示pending，共33欄；本批新增四篇共8欄。未解決問題沒有因此減少；台北網球場新發現取消差異仍待寫入runtime，這項未反映JSON的pending數；無pending也需定期覆核。下次完整查核期限2026-12-08。
...
C02剩餘5筆依計畫順序排列：天母、南港、玉成、中研、新生皆已查核但來源／現況未解；另32筆中，C03有8筆待來源、C04前組尚8筆未發布；16筆校園已有首輪處置；台科／木柵有新指南候選，其餘保留具體來源缺口。觀海／溪洲／雙園已發布移至上表。
...
| P3 | 台北醫學大學網球場／`tmu` | 信義區 | 可發布 | 未發布 | 本機指南完成；信義位置、新版草皮費及會員規則已核對；時段／硬地費／入口保留pending | [2026-09-09 C04補強](court-guide-completion-c04-followup-2026-09-09.md) |
...
| P3 | 三民國中網球場／`sanmin-junior-high` | 內湖區 | 可發布 | 未發布 | 本機指南完成；240元面時＋夜照50與申請流程已核對，待發布驗收 | [2026-09-09 C04補強](court-guide-completion-c04-followup-2026-09-09.md) |
...
| P3 | 台灣科技大學網球場／`ntust` | 大安區 | 可發布候選 | 未發布 | 2025-09-23費表週末校外400元面時；待基本指南實作／時段及位置核對 | [2026-09-09 C04校園收尾](court-guide-completion-c04-schools-final-2026-09-09.md) |
...
| P3 | 木柵國小網球場／`muzha-elementary` | 文山區 | 可發布候選 | 未發布 | 季租兩面440元時，網站220單位歧義；受理期已過，待指南及下一季狀態 | [2026-09-09 C04校園收尾](court-guide-completion-c04-schools-final-2026-09-09.md) |
