...
- command JSON 中的 generation、delivery／outbox／profile ID、transport version 與毫秒 policy 都先 cast 成
  canonical decimal string，符合 v1.3 的 bigint boundary，不經 JavaScript number。
