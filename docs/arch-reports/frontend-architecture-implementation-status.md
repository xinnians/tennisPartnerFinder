...
`frontend-architecture-fa-06-stage-6b4-chat-react-owner-2026-09-08.md`。
...
| 目前批次                | `FA-06 stage 6B.4` 完成：Chat feed 已成為 React 可直接訂閱的 immutable state，舊 Chat imperative state／DOM adapter 已退役；尚待 6B.5 app wiring                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 整體狀態                | `FA-00`、`FA-01`、`FA-02` 完成；FA-03 preflight、`FA-03A0`～`FA-03A4`、`FA-03B0`～`FA-03B11.1`、`FA-03B12.1`～`FA-03B12.9`、`FA-03B13` preflight／B13.1 Auth adapter／B13.2 disabled shell、dispatcher D0.1／D0.2／D1／D2／D3A local composition、cleanup limiter foundation、全部 39 份 Hosted migration 與獨立 Hosted canary 執行環境、`FA-04 phase 0a／0b`、`FA-05 phase 1／2／3`、`FA-06 stage 4` preflight／4.1～4.6、stage 5 preflight／5.1、stage 6 preflight／6.0／6A／6B.1～6B.4 已完成；active D2／D3A source 尚未部署 Hosted，Hosted v2 runtime 未啟用                                                                                                                                                                                                  |
...
| 下一步                  | 執行 `FA-06 stage 6B.5`：controller 只建立 Chat session/model，由 app wiring 選擇 concrete surface，刪除兩層 `openChat` callback 與 main mapping；Hosted C 真實 Push 與 B13.3 UI 仍分別等待產品確認                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| FA-06 | `sessionViews` wiring、blockedPlayers、Chat／Messages ownership   | 階段 4 preflight／4.1～4.6、stage 5 preflight／5.1、Stage 6 preflight／6.0／6A／6B.1～6B.4 完成；下一步 6B.5 app wiring                                                                                                                                                                                                                                        | 每個新 owner 都伴隨舊 bridge 刪除與完整回歸                                                                                                                                                               |
...
1. 確認分支為 `codex/frontend-architecture-execution`，先讀本文件、`FA-03B10` Push v2 contract v1.3、
   ...
   owner、6B.3 Chat surface 邊界 preflight 與 6B.4 React 單一 UI owner 已完成；不要恢復
   ...
   view DOM mutation 或 native listener 放回去。下一步做 6B.5 app wiring：controller 只建立 Chat session/model，由 app
   wiring 選 concrete surface，完成後才可宣告 Stage 6B 完成。
