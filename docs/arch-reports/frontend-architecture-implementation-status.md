...
| 目前批次                | Hosted limiter canary 通過並復原：1 未授權維持 limiter 0；20 授權為 1 ALLOW／19 LIMIT／0 failure，DB exact 1 global＋1 source，Function／RPC log exact 21／20。mode、Function、2 rows、4 Secrets 全部移除，既有 Function hash 與資料基線不變                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| 下一步                  | 提交 Hosted limiter 結果文件；下一批先唯讀盤點 production cleanup wiring、實際 client 觸發頻率與可觀測依據，不直接把 canary policy 當 production policy，也不先啟用 Hosted cleanup                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
