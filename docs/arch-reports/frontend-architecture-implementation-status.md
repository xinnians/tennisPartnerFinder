...
| 目前批次                | 真正 Hosted limiter canary 的 retry preflight 完成：沿用已核可 canary policy；固定 1 未授權＋20 授權 request、預期 1 ALLOW／19 LIMIT、exact 2 rows 與 transaction guard。guard 已在 local temporary table 通過；Hosted 尚未執行                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| 下一步                  | 提交 limiter retry preflight 後重新確認 Hosted 37／21、17／0 cleanup、limiter 0 與 DB server timestamp；完全符合才依固定範圍執行，任一結果不符即停損並復原                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
