...
| 目前批次                | `FA-03B13.6a` Hosted subscription source gate 完成：Hosted marker＋exact `hosted-v1` 才可能建立 handler；mode／runtime／Origin 不符或建構失敗都固定 503，本機 `local-test-v1` 不變。真實 local Edge → Auth → DB → IndexedDB 1／1 與完整 frontend CI 通過；沒有 deploy、Secret、request 或 DB/runtime write                                                                                                                                                                                                                                                                                                                                                                                                          |
| 整體狀態                | `FA-00`、`FA-01`、`FA-02` 完成；FA-03 preflight、`FA-03A0`～`FA-03A4`、`FA-03B0`～`FA-03B11.1`、`FA-03B12.1`～`FA-03B12.9`、`FA-03B13` preflight／B13.1 Auth adapter／B13.2 disabled shell／B13.3 dormant UI mapping＋privacy／B13.4 dormant sign-out cleanup／B13.5 timeout preflight／B13.5a～B13.5d／B13.6 activation audit／B13.6a Hosted subscription source gate、dispatcher D0.1／D0.2／D1／D2／D3A local composition、cleanup limiter foundation、全部 39 份 Hosted migration 與獨立 Hosted canary 執行環境、`FA-04 phase 0a／0b`、`FA-05 phase 1／2／3`、`FA-06 stage 4` preflight／4.1～4.6、stage 5 preflight／5.1、stage 6 preflight／6.0／6A／6B.1～6B.5 已完成；第一個 vertical slice 完成；active D2／D3A source 尚未部署 Hosted，Hosted v2 runtime 未啟用                                                                                                                                                                                                                                                           |
...
| 下一步                  | 做 `FA-03B13.6b` active dispatcher entry 唯讀複核：確認先部署 format-1 compatible legacy entry 與新增 Hosted v2 entry 是否必須拆批，鎖定 mode disabled 時的精確行為；不改 source／Hosted、不猜 lease／deadline／attempt／TTL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
