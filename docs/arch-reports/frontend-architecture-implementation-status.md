...
gate 與 WebKit select 修正在 `frontend-architecture-ds-bundle-touch-gate-2026-09-08.md`。
...
| 目前批次                | `ds-bundle` 批次 D 完成：Buttons／Chips 補回 production container，9 張卡在 390×844 共 84 個可操作項目、0 筆低於 44×44px；新增三瀏覽器 computed-size gate。建 gate 時另以設計卡和正式 React 畫面確認 WebKit 兩個 edit select 原為 22px，scoped 修正後為 44px                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| 下一步                  | 做 `ds-bundle` completion audit：只讀確認 deterministic sync、9-card integrity、mobile computed-size 與文件入口已閉環，再判斷下一個不受產品／Hosted 邊界限制的工作；Hosted C 真實 Push、B13.3 UI、production runtime 與真實 Google marker 仍遵守既定確認／證據邊界                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
