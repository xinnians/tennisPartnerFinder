    ...
    projects: [
      {
        ...
        testMatch:
          /(?:smoke|performance|error-boundary|react-unmount|react-page-focus|auth-lock|push-storage|push-cleanup-transport|push-subscription-v2-protocol|push-subscription-transport)\.spec\.js/,
