  ...
  async () => {
    ...
    try {
      ...
      const environment = [
        ...
        `NOTIFICATION_DISPATCH_V2_CANARY_EXPECTED_GENERATION=${TEST_GENERATION}`,
        `NOTIFICATION_DISPATCH_V2_CANARY_DATABASE_URL=postgresql://notification_dispatcher:${rolePassword}@host.docker.internal:54322/postgres?sslmode=disable`,
        "NOTIFICATION_DISPATCH_V2_CANARY_TRANSPORT=deno-native-web-push-v1",
        'NOTIFICATION_DISPATCH_V2_CANARY_PROVIDER_ORIGINS_V1=["https://www.google.com"]',
